...
@Composable
fun FakeGPSAlert(navController : NavController) {
...
//    isDeveloperEnabled.value = Settings.Secure.getInt(context.contentResolver, Settings.Global.DEVELOPMENT_SETTINGS_ENABLED) == 1
    ...
    val text1 = if(isMockLocation.value) "Fake GPS Detected..!" else "Mock location is now turned off..."
    val text2 = if(isMockLocation.value) "Turn off mock location to proceed..." else "You can proceed now..."
...
//                if(isDeveloperEnabled.value && isMockLocation.value)
